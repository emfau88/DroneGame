...
export const MAP_TEMPLATES = [
  {
    ...
    setting: 'bridge',
    difficulty: 1,
    enemies: { soldier: [4,6], rocket: [1,2], tank: [1,1], flakGun: [1,1], commander: [0,0], enemyDrone: [0,0] },
  ...
  },
  {
    ...
    setting: 'desert',
    difficulty: 2,
    enemies: { soldier: [5,7], rocket: [2,3], tank: [1,2], flakGun: [2,2], commander: [0,1], enemyDrone: [0,0] },
  ...
  },
  {
    ...
    setting: 'forest',
    difficulty: 3,
    enemies: { soldier: [6,8], rocket: [2,4], tank: [2,3], flakGun: [2,3], commander: [1,1], enemyDrone: [1,2] },
